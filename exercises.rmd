...
#  plot(dat_female$age, dat_female$sysBP)
```
...
grade_result(
  pass_if(~ identical(.result, fit_m$coefficients[1] + 40 * fit_m$coefficients[2] ), ""),
  pass_if(~ identical(.result, fit_f$coefficients[1] + 40 * fit_f$coefficients[2] ), "")
  )
```
  -->
</div>
