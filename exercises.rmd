...
<font size="+1"> **Welcome to the R-4-ScHARR introductory R course site. We hope that you find the course content useful.** </font>

<br>

This web page contains (see navigation bar):

  *  Instructions on how to install R and R Studio

  * Practical exercises for Session 1-3

  * [Links to additional resources](#link_Resources)
