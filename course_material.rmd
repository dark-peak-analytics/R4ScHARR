...
It is assumed that all participants on the course have their own laptop, and have installed R and RStudio. It is also assumed that participants have a high-school level understanding of statistics and mathematics (e.g. mean, median, minimum, maximum). We do not go into any detail on statistical methods, focusing exclusively on programming in R. 
